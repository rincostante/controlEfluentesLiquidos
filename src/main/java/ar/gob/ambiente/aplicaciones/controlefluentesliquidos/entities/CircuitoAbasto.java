 ...
 */
@Entity
public class CircuitoAbasto implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CircuitoAbasto)) {
            return false;
        }
        CircuitoAbasto other = (CircuitoAbasto) object;
    ...
    public String toString() {
        return "ar.gob.ambiente.aplicaciones.controlefluentesliquidos.entities.CircuitoAbasto[ id=" + id + " ]";
    }
